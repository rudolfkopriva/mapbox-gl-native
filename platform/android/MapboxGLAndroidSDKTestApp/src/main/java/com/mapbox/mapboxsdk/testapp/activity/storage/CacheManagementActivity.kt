...
class CacheManagementActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    resetDatabaseButton.setOnClickListener {
      fileSource.resetDatabase(object : FileSource.FileSourceCallback {
    ...
    invalidateAmbientCacheButton.setOnClickListener {
      fileSource.invalidateAmbientCache(object : FileSource.FileSourceCallback {
        override fun onSuccess() {
    ...
    clearAmbientCacheButton.setOnClickListener {
      fileSource.clearAmbientCache(object : FileSource.FileSourceCallback {
        override fun onSuccess() {
    ...
    setMaximumAmbientCacheSizeButton.setOnClickListener {
      fileSource.setMaximumAmbientCacheSize(5000000, object : FileSource.FileSourceCallback {
        override fun onSuccess() {
